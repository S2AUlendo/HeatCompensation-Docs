...
prt0=dyn.ops.import_part(path=r"C:\Users\sthom\Documents\Development\Products\UlendoHC\input\Figure 1A_opt_orientation.stl",
    auto_center=True,
    transform=None,
    translate_only=None,
...
def cb(ctx: dyn.LayerContext, writer: dyn.VectorWriter, layer_idx):
    ...
    # stripeAngle = (stripeAngleVal * layer_idx) % 360
    ...
    if MERGE_HATCHES == 0:
        ...
        ctx.scan_line_infill_fragments(fragments=sorted_frags,
                                params=hatching_params,
                                merge_tol=2,
                                merge_max=None,
                                relax_segment_boundaries=True,
                                drop_unmerged=False,
                                overscan=0.0)
